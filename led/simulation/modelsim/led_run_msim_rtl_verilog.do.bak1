...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/led {C:/intelFPGA_lite/17.1/project/led/ledtest.v}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/led {C:/intelFPGA_lite/17.1/project/led/ledtest_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  ledtest_tb
