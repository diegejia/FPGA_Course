...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/DFF {C:/intelFPGA_lite/17.1/project/DFF/DFF.v}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/DFF {C:/intelFPGA_lite/17.1/project/DFF/DFF_32_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  DFF_32_tb
