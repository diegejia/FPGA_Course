...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/fanmaiji {C:/intelFPGA_lite/17.1/project/fanmaiji/fanmaiji.v}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/fanmaiji {C:/intelFPGA_lite/17.1/project/fanmaiji/fanmaiji_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  fanmaiji_tb
