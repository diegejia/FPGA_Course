...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/pll_test {C:/intelFPGA_lite/17.1/project/pll_test/pll_test.v}
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/pll_test/pcore {C:/intelFPGA_lite/17.1/project/pll_test/pcore/pll.v}
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/pll_test/db {C:/intelFPGA_lite/17.1/project/pll_test/db/pll_altpll.v}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/17.1/project/pll_test {C:/intelFPGA_lite/17.1/project/pll_test/pll_test_tb.v}
